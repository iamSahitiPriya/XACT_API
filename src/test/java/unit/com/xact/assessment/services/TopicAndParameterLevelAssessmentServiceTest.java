...
public class TopicAndParameterLevelAssessmentServiceTest {
    ...
    void shouldSaveAssessmentRatingAndRecommendationForTopicLevel(){
        ...
        RatingAndRecommendationDto ratingAndRecommendationDto = new RatingAndRecommendationDto();
        ratingAndRecommendationDto.setTopicId(1);

        ratingAndRecommendationDto.setRating(RatingDto.ONE);
        ratingAndRecommendationDto.setRecommendation("some text");

        Assessment assessment = new Assessment();
        assessment.setAssessmentId(assessmentId);

        TopicLevelId topicLevelId = mapper.map(ratingAndRecommendationDto, TopicLevelId.class);
        topicLevelId.setAssessment(assessment);
        TopicLevelAssessment topicLevelAssessment = mapper.map(ratingAndRecommendationDto, TopicLevelAssessment.class);
    ...
    void shouldUpdateAssessmentRatingAndRecommendationForTopicLevel() {
        ...
        TopicLevelId topicLevelId1 = mapper.map(ratingAndRecommendationDto1, TopicLevelId.class);
        topicLevelId1.setAssessment(assessment1);
        TopicLevelAssessment topicLevelAssessment1 = mapper.map(ratingAndRecommendationDto1, TopicLevelAssessment.class);
        ...
        ratingAndRecommendationDto2.setRating(RatingDto.TWO);
        ratingAndRecommendationDto2.setRecommendation("some update text");

        Assessment assessment2 = new Assessment();
        assessment2.setAssessmentId(assessmentId2);

        TopicLevelId topicLevelId2 = mapper.map(ratingAndRecommendationDto2, TopicLevelId.class);
        topicLevelId2.setAssessment(assessment2);
        TopicLevelAssessment topicLevelAssessment2 = mapper.map(ratingAndRecommendationDto2, TopicLevelAssessment.class);
    ...
    void shouldSaveAssessmentRatingAndRecommendationForParameterLevel(){
        Integer assessmentId = 1;
        RatingAndRecommendationDto ratingAndRecommendationDto = new RatingAndRecommendationDto();
        ratingAndRecommendationDto.setParameterId(1);
        ...
        ParameterLevelId parameterLevelId = mapper.map(ratingAndRecommendationDto, ParameterLevelId.class);
        parameterLevelId.setAssessment(assessment);
        ParameterLevelAssessment parameterLevelAssessment = mapper.map(ratingAndRecommendationDto, ParameterLevelAssessment.class);
    ...
    void shouldUpdateAssessmentRatingAndRecommendationForParameterLevel() {
        ...
        Integer assessmentId1 = 1;
        RatingAndRecommendationDto ratingAndRecommendationDto1 = new RatingAndRecommendationDto();
        ratingAndRecommendationDto1.setParameterId(1);
        ratingAndRecommendationDto1.setRating(RatingDto.ONE);
        ratingAndRecommendationDto1.setRecommendation("some text");
        ...
        ParameterLevelId parameterLevelId = mapper.map(ratingAndRecommendationDto1, ParameterLevelId.class);
        parameterLevelId.setAssessment(assessment1);
        ParameterLevelAssessment parameterLevelAssessment = mapper.map(ratingAndRecommendationDto1, ParameterLevelAssessment.class);
        parameterLevelAssessment.setParameterLevelId(parameterLevelId);
        ...
        Integer assessmentId2 = 1;
        RatingAndRecommendationDto ratingAndRecommendationDto2 = new RatingAndRecommendationDto();
        ratingAndRecommendationDto2.setParameterId(1);
        ratingAndRecommendationDto2.setRating(RatingDto.TWO);
        ratingAndRecommendationDto2.setRecommendation("some update text");
        ...
        ParameterLevelId parameterLevelId1 = mapper.map(ratingAndRecommendationDto2, ParameterLevelId.class);
        parameterLevelId1.setAssessment(assessment2);
        ParameterLevelAssessment parameterLevelAssessment1 = mapper.map(ratingAndRecommendationDto2, ParameterLevelAssessment.class);
