...
public class UserAssessmentModuleServiceTest {
    ...
    void shouldReturnTrueWhenUserAssessmentModuleExists() {
        ...
        when(userAssessmentModuleRepository.save(userAssessmentModule)).thenReturn(userAssessmentModule);
        when(userAssessmentModuleRepository.existsById(userAssessmentModule.getAssessmentModuleId())).thenReturn(true);
        userAssessmentModuleService.save(userAssessmentModule);

        Assertions.assertTrue(userAssessmentModuleService.existsById(userAssessmentModule.getAssessmentModuleId()));
