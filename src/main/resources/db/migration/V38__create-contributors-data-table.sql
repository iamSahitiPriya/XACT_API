create table tbl_contributors_data (
                                ...
                                question_status varchar(20)  DEFAULT 'Idle' CHECK(question_status='Sent_For_Review' OR question_status='Approved' OR question_status='Rejected' OR question_status='Requested_For_Change' OR question_status='Idle'),
